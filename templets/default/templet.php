<div class="WidgetArticleDefault">
	<div class="listTitle">
		<?php echo $titleIcon ? $titleIcon : '<i class="fa fa-leaf"></i>'; ?>
		<b><?php echo $title; ?></b>
	...
	<ul>
		...
		<li<?php echo $lists[$i]->reg_date > time() - 60*60*24*3 ? ' class="new"' : ''; ?>>
			<a href="<?php echo $lists[$i]->link; ?>">
				...
				<span class="type <?php echo $lists[$i]->type; ?><?php echo $lists[$i]->is_selected == true ? ' selected' : ''; ?>"><?php echo substr(strtoupper($lists[$i]->type),0,1); ?></span>
				<?php } ?>
